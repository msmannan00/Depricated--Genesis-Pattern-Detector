            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">Matbot | ML Model Info</h1>
	                        <p class="hero-paragraph">List of all ML Model Obtain against your query. It can also be extended to see actual data</p>
						</div>
                    </div>
                      <div class="list-group">
                <form action="genericDisplay.php" method="post" enctype="multipart/form-data">
                          <?php 
                          $result = file_get_contents('visualization/mvisual.txt');
                          if(strlen($result)<=2)
                          {
                              return;
                          }
                          ...
                          foreach($resultset as $item) 
                          {
                              ...
                              if(sizeof($resultsetItem)>1)
                              {
                                 ...
                                 echo "<p class=\"list-group-item-text\" style=\"text-decoration: none\">".$link."   ::   ".$resultsetItem[1]."</p>";
                                 echo "</a>";
                                 $counter++;
