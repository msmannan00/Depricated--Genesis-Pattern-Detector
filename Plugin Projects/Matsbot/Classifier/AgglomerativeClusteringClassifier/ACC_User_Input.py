...
def runProgram(comment):
    #INITIALIZING
    loaded_model = pickle.load(open(Strings.agglomerative_model_location, 'rb'))
    loaded_selector = pickle.load(open(Strings.selectK_best_model_location+"_agglomerative_cluster", 'rb'))
    count_vectorizer = pickle.load(open(Strings.count_vectorizer_model_location+"_agglomerative_cluster", 'rb'))
